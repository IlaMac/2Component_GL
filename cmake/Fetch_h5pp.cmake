...
elseif(DOWNLOAD_METHOD MATCHES "native")
    ...
    list(APPEND H5PP_CMAKE_OPTIONS  -DDOWNLOAD_METHOD=${DOWNLOAD_METHOD})
    list(APPEND H5PP_CMAKE_OPTIONS  -DPREFER_CONDA_LIBS:BOOL=${PREFER_CONDA_LIBS})
    list(APPEND H5PP_CMAKE_OPTIONS  "-Dhdf5_DIR:PATH=$ENV{CONDA_PREFIX};$ENV{HOME}/anaconda3;$ENV{HOME}/miniconda3;$ENV{HOME}/miniconda3/envs/gl")
