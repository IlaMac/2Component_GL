...
elseif(DOWNLOAD_METHOD MATCHES "native")
    ...
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_DOWNLOAD_METHOD=${DOWNLOAD_METHOD})
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_ENABLE_MPI=${ENABLE_MPI})
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_ENABLE_EIGEN3=${ENABLE_EIGEN3})
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_ENABLE_SPDLOG=${ENABLE_SPDLOG})
    list(APPEND H5PP_CMAKE_OPTIONS  -DH5PP_PREFER_CONDA_LIBS:BOOL=${PREFER_CONDA_LIBS})
