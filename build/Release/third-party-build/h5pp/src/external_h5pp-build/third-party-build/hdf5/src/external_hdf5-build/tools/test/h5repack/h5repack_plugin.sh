...
# help@hdfgroup.org.
#
srcdir=/home/ilaria/Desktop/MultiComponents_SC/2Components_GL/build/Release/third-party-build/h5pp/src/external_h5pp-build/third-party-build/hdf5/src/external_hdf5/tools/test/h5repack
TOP_BUILDDIR=../../..
...
# prepare for test
COPY_TESTFILES_TO_TESTDIR
version_str=`echo 1.10.5 | awk -F"-" '{print $1}' | sed 's/\./,/g'`
